...
- `Raw/` is read-only source evidence for this task. The editable files in
  `Blender/` and the FBX/Unity assets are deterministic rebuilt derivatives,
  not a claim that the original raw export was recovered from the first copy.
...
- Third-party logo or protected-character check: none observed in supplied input or rebuilt benchmark
- Blender cleanup file: `Blender/SM_Benchmark_WorkTable_01.blend`
...
- User-confirmed license/use-right status: pending explicit Studio Owner confirmation
- Third-party logo or protected-character check: none observed in supplied input or rebuilt benchmark
- Blender cleanup file: `Blender/SM_Benchmark_CoffeeMachine_01.blend`
...
- User-confirmed license/use-right status: pending explicit Studio Owner confirmation
- Third-party logo or protected-character check: none observed in supplied input or rebuilt benchmark
- Blender cleanup file: `Blender/SM_Benchmark_CeramicCup_01.blend`
